...
For example, here's one of the todo app's integration tests:
...
todo app) it's probably good practice to encapsulate this string within the fixture script subclass, eg:
...
A better approach, therefore, is to have the fixture scripts simply invoke the relevant actions and other business logic
...
The todo app (generated by the [todo app archetype](../intro/getting-started/todoapp-archetype.html) uses fixture
...
The todo app's fixture hierarchy as implemented is quite flat:

<img src="images/fixture-scenario-hierarchy-1.png" width="800"></img>
...
<img src="images/fixture-scenario-hierarchy-2.png" width="800"></img>
